...
build_time_vars = {
    ...
    "ALT_SOABI": 0,
    "ANDROID_API_LEVEL": 0,
    "AR": "/tmp/tmpeq32q37d/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    ...
    "FILEMODE": 644,
    "FREEZE_MODULE": "/tmp/tmpeq32q37d/tools/host/bin/python3.12 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/tmp/tmpeq32q37d/tools/host/bin/python3.12 ./Programs/_freeze_module.py",
    ...
    "LLVM_PROFDATA": "/tmp/tmpeq32q37d/tools/llvm/bin/llvm-profdata",
    "LLVM_PROF_ERR": "no",
    "LLVM_PROF_FILE": "LLVM_PROFILE_FILE=\"$(shell pwd)/code-%128m.profclangr\"",
    "LLVM_PROF_MERGER": "/tmp/tmpeq32q37d/tools/llvm/bin/llvm-profdata merge -output=\"$(shell pwd)/code.profclangd\" \"$(shell pwd)\"/*.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/tmp/tmpeq32q37d/Python-3.12.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmpeq32q37d/Python-3.12.14/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /tmp/tmpeq32q37d/tools/host/bin/python3.12",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/tmp/tmpeq32q37d/tools/host/bin/python3.12",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    ...
    "PY_CFLAGS_NODIST": "-flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/tmp/tmpeq32q37d/Python-3.12.14/code.profclangd -I./Include/internal",
    ...
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/tmp/tmpeq32q37d/Python-3.12.14",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "DYLD_LIBRARY_PATH=/private/tmp/tmpeq32q37d/Python-3.12.14 _PYTHON_PROJECT_BASE=/private/tmp/tmpeq32q37d/Python-3.12.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmpeq32q37d/Python-3.12.14/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /tmp/tmpeq32q37d/tools/host/bin/python3.12",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "DYLD_LIBRARY_PATH=/private/tmp/tmpeq32q37d/Python-3.12.14 _PYTHON_PROJECT_BASE=/private/tmp/tmpeq32q37d/Python-3.12.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmpeq32q37d/Python-3.12.14/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /tmp/tmpeq32q37d/tools/host/bin/python3.12 ./Tools/scripts/run_tests.py",
    ...
    "abs_builddir": "/private/tmp/tmpeq32q37d/Python-3.12.14",
    "abs_srcdir": "/private/tmp/tmpeq32q37d/Python-3.12.14",
